...
final class StorageManager {
    ...
    func edit(_ taskTitle: Task, taskNote: Task, newValueTitle: String, newValueNote: String) {
        write {
            taskTitle.title = newValueTitle
            taskNote.note = newValueNote
        }
    }
